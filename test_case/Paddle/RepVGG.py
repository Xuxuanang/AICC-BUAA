...
class RepVGGBlock(paddle.nn.Layer):
    def __init__(self,
        ...
        self.rbr_identity = paddle.nn.BatchNorm2D(
    ...
    def rep(self):
        if not hasattr(self, 'rbr_reparam'):
            self.rbr_reparam = paddle.nn.Conv2D(
    ...
    def _pad_1x1_to_3x3_tensor(self, kernel1x1):
        if kernel1x1 is None:
            ...
            return paddle.nn.functional.pad(kernel1x1, [1, 1, 1, 1])
    ...
    def _fuse_bn_tensor(self, branch):
        ...
        if isinstance(branch, ConvBN):
            ...
            assert isinstance(branch, paddle.nn.BatchNorm2D)
...
class RepVGG(paddle.nn.Layer):
    def __init__(self,
        ...
        self.gap = paddle.nn.AdaptiveAvgPool2D(output_size=1)
        self.linear = paddle.nn.Linear(int(512 * width_multiplier[3]), class_num)
