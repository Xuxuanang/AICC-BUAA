...
class WindowAttention(paddle.nn.Layer):
    ...
    def __init__(self,
        ...
        self.qkv = paddle.nn.Linear(dim, dim * 3, bias_attr=False)
        if qkv_bias:
    ...
    def forward(self, x, mask=None):
        ...
        # cosine attention
        attn = (paddle.nn.functional.normalize(
            q, axis=-1) @paddle.nn.functional.normalize(
...
class SwinTransformerBlock(paddle.nn.Layer):
    ...
    Args:
        ...
        act_layer (paddle.nn.Module, optional): Activation layer. Default: paddle.nn.GELU
        norm_layer (paddle.nn.Module, optional): Normalization layer.  Default: paddle.nn.LayerNorm
...
class PatchMerging(paddle.nn.Layer):
    ...
    def __init__(self, input_resolution, dim, norm_layer=paddle.nn.LayerNorm):
        super().__init__()
        self.input_resolution = input_resolution
        self.dim = dim
...
class BasicLayer(paddle.nn.Layer):
    ...
    Args:
        ...
        norm_layer (paddle.nn.Module, optional): Normalization layer. Default: paddle.nn.LayerNorm
        downsample (paddle.nn.Module | None, optional): Downsample layer at the end of the layer. Default: None
...
class PatchEmbed(paddle.nn.Layer):
    ...
    Args:
        ...
        norm_layer (paddle.nn.Module, optional): Normalization layer. Default: None
    """
    ...
    def maybe_pad(self, pixel_values, height, width):
        if width % self.patch_size[1] != 0:
            ...
            pixel_values = paddle.nn.functional.pad(pixel_values, pad_values)
...
class SwinTransformerV2(paddle.nn.Layer):
    ...
    Args:
        ...
        norm_layer (paddle.nn.Layer): Normalization layer. Default: paddle.nn.LayerNorm.
    ...
    def __init__(self,
        ...
        self.head = paddle.nn.Linear(self.num_features,
                              class_num) if class_num > 0 else paddle.nn.Identity()
