...
class GoogLeNet(torch.nn.Module):
    ...
    def __init__(
        ...
        blocks: Optional[List[Callable[..., torch.nn.Module]]] = None,
        dropout: float = 0.2,
        ...
        self.maxpool1 = torch.nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.conv2 = conv_block(64, 64, kernel_size=1)
        self.conv3 = conv_block(64, 192, kernel_size=3, padding=1)
        self.maxpool2 = torch.nn.MaxPool2d(3, stride=2, ceil_mode=True)

        self.inception3a = inception_block(192, 64, 96, 128, 16, 32, 32)
        self.inception3b = inception_block(256, 128, 128, 192, 32, 96, 64)
        self.maxpool3 = torch.nn.MaxPool2d(3, stride=2, ceil_mode=True)
        ...
        self.maxpool4 = torch.nn.MaxPool2d(2, stride=2, ceil_mode=True)
