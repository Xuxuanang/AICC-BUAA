...
class InvertedResidual(torch.nn.Module):
    ...
    def __init__(
        ...
        se_layer: Callable[..., torch.nn.Module] = partial(SElayer, scale_activation=torch.nn.Hardsigmoid),
    ):
        super().__init__()
        ...
        activation_layer = torch.nn.Hardswish if cnf.use_hs else torch.nn.ReLU
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.classifier = torch.nn.Sequential(
            torch.nn.Linear(lastconv_output_channels, last_channel),
