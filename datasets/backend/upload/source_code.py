...
class ResNet50(mindspore.nn.Cell):
    ...
    def __init__(self, Bottleneck, num_classes=10) -> None:
        ...
        self.in_channels = 64
        self.conv1 = mindspore.nn.SequentialCell(mindspore.nn.Conv2d(3, 64, 1, 1, pad_mode='valid', padding=0, has_bias=False), mindspore.nn.BatchNorm2d(64), mindspore.nn.MaxPool2d(3, 2, 'same'))
